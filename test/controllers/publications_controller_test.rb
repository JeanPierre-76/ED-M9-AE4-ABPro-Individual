...
class PublicationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create publication" do
    assert_difference("Publication.count") do
      post publications_url, params: { publication: { cuerpo: @publication.cuerpo, encabezado: @publication.encabezado, link: @publication.link } }
    end
  ...
  test "should update publication" do
    patch publication_url(@publication), params: { publication: { cuerpo: @publication.cuerpo, encabezado: @publication.encabezado, link: @publication.link } }
